...
export default class UserSelect extends Component {
  render() {
    return (
      <Container className="bg-secondary" fluid style={{ height: '800px' }}>
        <Navbar bg="dark" className="justify-content-md-center" fluid="true" style={{ marginBottom: '20px' }} variant="dark">
          <Nav>
            <Button variant="outline-success">Back</Button>
          </Nav>
          <Card bg="dark" border="dark" className="text-center" style={{ marginLeft: '500px', height: 'auto', width: 'auto' }} text="white">
            <Card.Title>Create Playlist</Card.Title>
          </Card>
          <Form inline>
            <Button style={{ marginLeft: '500px' }} variant="outline-success">Next</Button>
          </Form>
        </Navbar>
